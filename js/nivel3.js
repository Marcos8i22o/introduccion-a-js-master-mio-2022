...
document.querySelector('h1').textContent = "Hola Marcos";
...
$facebook.style.color = "brown";

const $twitter = document.querySelector('.twitter');
$twitter.style.color = "yellow";
...
// Tarea: Todavía seguís teniendo a los gatitos en tu pantalla? 
//       A mí me gusta el logo y los gatitos.
//       Creá una nueva imagen con nuestro logo como fuente, y ponela
//       en nuestra cabecera.

const $cabecera = document.querySelector('header');
const $logo = document.createElement('img');
$logo.src = "img/woman_bw.jpg";
