...
// TAREA: Cambiar el operador a '-', 
// y fijarse que llame a la función 'restar' en vez de a la de 'sumar'.

/*
let operador = prompt("Ingrese un operador : " + " + ó - ");
...
$inputNumero1.placeholder = "Ingrese un número";
$inputNumero1.id = "numero1";

const $inputNumero2 = document.createElement('input');
$inputNumero2.type = "number";
$inputNumero2.placeholder = "Ingrese otro número";
$inputNumero2.id = "numero2";


function agregarElemento(nodoPadre,nodoHijo){
    nodoPadre.appendChild(nodoHijo);
}

function crearBotonOperador(operador){
    const $botonOperador = document.createElement('button');
    const $textoBotonOperador = document.createTextNode(operador);
    $botonOperador.appendChild($textoBotonOperador);
    $botonOperador.type = "button";

    return $botonOperador;
}

const $division = crearBotonOperador("/");
const $suma = crearBotonOperador("+");
const $resta = crearBotonOperador("-");
const $multiplicacion = crearBotonOperador("*");

agregarElemento($cabecera,$inputNumero1);
agregarElemento($cabecera,$inputNumero2);
agregarElemento($cabecera,$suma);
agregarElemento($cabecera,$resta);
agregarElemento($cabecera,$multiplicacion);
agregarElemento($cabecera,$division);

const textoConsola = "El resultado de la operación es: ";

$suma.onclick = function () {
  const numero1 = Number(document.querySelector("#numero1").value);
  const numero2 = Number(document.querySelector("#numero2").value);
  console.log(`${textoConsola} ${sumar(numero1, numero2)}`);
};

$resta.onclick = function () {
  const numero1 = Number(document.querySelector("#numero1").value);
  const numero2 = Number(document.querySelector("#numero2").value);
  console.log(`${textoConsola} ${restar(numero1, numero2)}`);
};

$division.onclick = function () {
  const numero1 = Number(document.querySelector("#numero1").value);
  const numero2 = Number(document.querySelector("#numero2").value);
  console.log(`${textoConsola} ${dividir(numero1, numero2)}`);
};

$multiplicacion.onclick = function () {
  const numero1 = Number(document.querySelector("#numero1").value);
  const numero2 = Number(document.querySelector("#numero2").value);
  console.log(`${textoConsola} ${multiplicar(numero1, numero2)}`);
};
